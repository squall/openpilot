...
STATIC_MSGS = [
  ...
  (0x160, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER, CAR.HIGHLANDERH), 1,   7, '\x00\00\x0a\x12\x17\x31\x9c\x69'),
  ...
  (0x366, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.HIGHLANDERH), 0,  20, '\x27\x31\x07\xff\x4f\x00\x00'), #\x09\x4c\x07\xff\x0f\x00\x33\x00 , \x27\x31\x07\xff\x08\x78\x00
  (0x366, ECU.DSU, (CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER), 0,  20, '\x00\x72\x07\xff\x09\xfe\x00'),
  
  (0x411, ECU.DSU, (CAR.RAV4H), 0, 100, '\x88\x20\x00\x00\x10\x00\x80\x00'), #new

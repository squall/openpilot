...
STATIC_MSGS = [
  ...
  (0x245, ECU.CAM, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER, CAR.HIGHLANDERH), 1,   25, '\x00\x00\x00\x80\xcc'),  #\x00\x10\x01\x00\x10\x01\x00
  ...
  (0x367, ECU.CAM, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER, CAR.HIGHLANDERH), 0,  50, '\x00\x00\x00\x00'), #\x06\x00
  (0x414, ECU.CAM, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER, CAR.HIGHLANDERH), 0, 100, '\x00\x00\x00\x00\x00\x00\x00\x00'), #\x00\x00\x00\x00\x00\x00\x17\x00
  ...
  (0x48b, ECU.CAM, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER, CAR.HIGHLANDERH), 0, 100, '\x66\x00\x00\x00\x01\x00\x00\x00'), #\x66\x06\x08\x0a\x02\x00\x00\x00
  (0x4d3, ECU.CAM, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA), 0, 200, '\x1C\x00\x00\x01\x00\x00\x00\x00'),
  (0x128, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA), 1,   3, '\xf4\x01\x90\x83\x00\x37'),
  #(0x128, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA), 1,   3, '\x00\x80\x00\x00\x00\xaf'),
  #(0x123, ECU.DSU, (CAR.RAV4H), 1, 10,'\x01\x48\x00\x0d\x40\x00\xc1'), #new
  
  (0x128, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA), 0,   2, '\x00\x00\x00\x00\x00\x00\x00\x31'),
  #(0x128, ECU.DSU, (CAR.RAV4H), 1,   3, '\x00\x3f\xe4\x00\x00\x52'),
  (0x128, ECU.DSU, (CAR.HIGHLANDER, CAR.HIGHLANDERH), 1,   3, '\x01\x00\x24\x00\x00\x54'),
  #(0x130, ECU.DSU, (CAR.RAV4H), 1, 100, '\x00\x00\x00\x00\x80\x00\xb8'), #new, dynamic value , \x00\x00\x00\x00\x00\x00\x38
  ...
  (0x160, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER, CAR.HIGHLANDERH), 1,   7, '\x00\x00\x0a\x12\x01\x31\x9c\x53'),
 
  #(0x161, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA), 1,   7, '\x00\x1e\x00\x00\x00\x80\x07'),
  (0x161, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA), 1,   7, '\x00\x1e\x00\x04\x00\x00\x8b'), #dynamic value
  (0X161, ECU.DSU, (CAR.HIGHLANDERH, CAR.HIGHLANDER), 1,  7, '\x00\x1e\x00\xd4\x00\x00\x5b'),
  (0x1AA, ECU.DSU, (CAR.RAV4H), 1, 5, '\x00\x00\x00\x00\x00\xb1'),
  ...
  #(0x2E6, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH), 0,   3, '\xff\xf8\x00\x08\x7f\xe0\x00\x4e'), #none
  #(0x2E7, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH), 0,   3, '\xa8\x9c\x31\x9c\x00\x00\x00\x02'), #none
  #(0x33E, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH), 0,  20, '\x0f\xff\x26\x40\x00\x1f\x00'), #none
  #(0x343, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER, CAR.HIGHLANDERH), 0,   3, '\x00\x00\x81\x00\x00\x00\x00\xcf'), #new
  ...
  (0x365, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.HIGHLANDERH), 0,  20, '\x00\x00\x00\x80\xfc\x00\x08'),
  (0x365, ECU.DSU, (CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER), 0,  20, '\x00\x00\x00\x80\xfd\x00\x08'),
  #(0x366, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.HIGHLANDERH), 0,  20, '\x00\x00\x4d\x82\x40\x02\x00'),
  (0x366, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH, CAR.HIGHLANDERH), 0,  20, '\x27\x31\x07\xff\x08\x78\x00'), #\x09\x4c\x07\xff\x0f\x00\x33\x00
  (0x366, ECU.DSU, (CAR.RAV4, CAR.COROLLA, CAR.HIGHLANDER), 0,  20, '\x00\x72\x07\xff\x09\xfe\x00'),

  (0x411, ECU.DSU, (CAR.RAV4H), 0, 100, '\x00\x20\x00\x00\x10\x00\x80\x00'), #new
  #(0x412, ECU.DSU, (CAR.RAV4H), 0, 100, '\x68\x04\x12\x00\x00\x2c\x38\x02'), #new
  #(0x414, ECU.DSU, (CAR.RAV4H), 0, 100, '\x00\x00\x00\x00\x00\x00\x17\x00'), #new
  (0x466, ECU.DSU, (CAR.RAV4H), 1, 100, '\x44\x20\xd1'), #new, dynamic value
  (0x470, ECU.DSU, (CAR.PRIUS, CAR.RAV4H, CAR.LEXUS_RXH), 1, 100, '\x00\x00\x01\x79'),
  (0x470, ECU.DSU, (CAR.HIGHLANDER, CAR.HIGHLANDERH), 1,  100, '\x00\x00\x01\x79'),
  #(0x48B, ECU.DSU, (CAR.RAV4H), 0, 100, '\x66\x07\x0a\x0f\x01\x00\x00\x00'), #new
  ...
  (0x396, ECU.APGS, (CAR.PRIUS,  CAR.RAV4H), 0, 100, '\x69\x00\x00\x00\x60\x0f\x60'),  #\xBD\x00\x00\x00\x60\x0F\x02\x00
  ...
  (0x4CC, ECU.APGS, (CAR.PRIUS,  CAR.RAV4H), 0, 100, '\x0D\x00\x00\x00\x00\x00\x00\x00'),
]
